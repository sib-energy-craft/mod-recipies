...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                packaging = "jar"
                url = "https://github.com/sib-energy-craft/mod-recipes"
                ...
                scm {
                    connection.set("scm:https://github.com/sib-energy-craft/mod-recipes.git")
                    developerConnection.set("scm:git:ssh://github.com/sib-energy-craft")
                    url.set("https://github.com/sib-energy-craft/mod-recipes")
                }
    ...
    repositories {
        ...
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/sib-energy-craft/mod-recipes")
            credentials {
